            ...
            <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
             {files.length==0?(<DialogTitle id="form-dialog-title"> Please Upload your signature 
                ...
                <DialogActions>
                    ...
                    <input onChange={handleFileChange} ref={inputRef} accept="image/*" style={{ display: 'none' }} id="icon-button-file" type="file" />

                    <label htmlFor="icon-button-file">
                        <CustomButton color="primary" variant="contained" component="span" text="Upload" onClick={()=> {inputRef.current.click()}} icon={Backup}>Upload</CustomButton>
                    </label>
                   {(files.length==0 || preview==null)?(<div></div>):(<CustomButton color="primary" variant="contained" onClick={onSelect} text="Select">Select</CustomButton>
)}
